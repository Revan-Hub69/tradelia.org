...
type Translation = {
  ...
  metricChips: { value: string; label: string }[]
  positioningPills: string[]
  learningPillars: { title: string; body: string; metric: string; label: string }[]
  microModules: { title: string; detail: string; action: string }[]
  [key: string]: any
}
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] items-start">
              ...
              <div className="glass-panel p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  {t.microlearningCard.pills.map((pill: string, idx: number) => (
            ...
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
              ...
              <div className="glass-panel p-6 space-y-4">
                <div className="flex flex-wrap gap-4">
                  {t.metricChips.map((chip: { value: string; label: string }, idx: number) => (
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-2 items-start">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {t.positioningPills.map((pill: string, idx: number) => (
              ...
              <div className="glass-panel p-6 space-y-6">
                ...
                <div className="space-y-4">
                  {t.learningPillars.map((pillar: { title: string; body: string; metric: string; label: string }, idx: number) => (
        ...
        <section className="py-16 bg-[var(--bg-2)]">
          <div className="mx-auto max-w-6xl px-6 lg:px-8 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {t.microModules.map((module: { title: string; detail: string; action: string }, idx: number) => (
