    ...
    <div className="flex min-h-screen bg-[var(--bg)]">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          <div className="absolute inset-0 bg-[var(--backdrop)]" onClick={() => {}} />
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-[var(--surface)] shadow-lg border-r border-[var(--br)]">
            <Sidebar />
          </div>
        </div>
      )}
