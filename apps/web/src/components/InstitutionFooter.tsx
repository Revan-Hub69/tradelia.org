      ...
      <div className="mx-auto max-w-5xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-[var(--muted)] leading-relaxed mb-4 max-w-xl">
              Micro-lezioni statiche sugli errori finanziari più comuni. Nessuna registrazione, nessun tracciamento, solo contenuti educativi.
            </p>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-[var(--ink)]">Risorse</h4>
