...
export function EditorialHero({
  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-24 lg:py-28" id={id}>
      ...
      <svg
        aria-hidden="true"
        className="hidden lg:block absolute top-4 right-8 text-[var(--accent)]/45"
        width="180"
        height="180"
        viewBox="0 0 180 180"
        fill="none"
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 pt-2">
                  {primaryCta && (
                    <Link
                      ...
                      className="btn-primary px-5 py-3 text-base shadow-md w-full sm:w-auto"
                  ...
                  {tertiaryCta && (
                    <Link
                      ...
                      className="text-[var(--muted)] hover:text-[var(--ink)] text-sm font-semibold inline-flex items-center gap-2"
