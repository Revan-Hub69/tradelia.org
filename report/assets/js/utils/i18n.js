...
const TRANSLATIONS = {
  it: {
    ...
    'module.header.mifid.default': 'Output a fini educativi/informativi (orizzonte 3–10 giorni). Non costituisce consulenza o raccomandazione (MiFID II).',
    ...
    'pricing.faq.cancel.content': 'Sì, puoi cancellare il tuo abbonamento in qualsiasi momento dalla dashboard. Continuerai ad avere accesso fino alla fine del periodo già pagato.',
    'pricing.faq.trial.title': 'Come funziona la prova gratuita?',
    'pricing.faq.trial.content': 'Offriamo <strong>14 giorni di prova gratuita</strong> senza impegno. Puoi accedere a tutte le funzionalità della dashboard senza pagare nulla. Al termine dei 14 giorni, se non cancelli, l\'abbonamento si attiva automaticamente a €29/mese. Puoi cancellare in qualsiasi momento durante la prova gratuita senza costi.',
    'pricing.faq.payment.title': 'Come funziona il pagamento?',
    'pricing.faq.payment.content': 'I pagamenti sono gestiti in modo sicuro tramite Paddle. L\'abbonamento si rinnova automaticamente ogni mese. Puoi cambiare o cancellare in qualsiasi momento.',
    
    // Terms
    'terms.title': 'Termini di Servizio',
    'terms.lastUpdate': 'Ultimo aggiornamento:',
    'terms.section1.title': '1. Identità del Fornitore',
    'terms.section1.content1': '<strong>Tradelia AI</strong> ("noi", "nostro", "il Fornitore") è un progetto indipendente che fornisce servizi di analisi finanziaria attraverso piattaforma SaaS.',
    'terms.section1.content2': '<strong>Dati del Fornitore:</strong><br>Nome commerciale: Tradelia AI<br>Proprietario: Massimo Rodi<br>Email: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a><br>Sito web: <a href="https://tradelia.org" style="color: var(--brand-600); text-decoration: underline;">https://tradelia.org</a>',
    'terms.section2.title': '2. Accettazione dei Termini',
    'terms.section2.content': 'Accedendo e utilizzando Tradelia AI ("il Servizio"), accetti di essere vincolato da questi Termini di Servizio. Se non accetti questi termini, non utilizzare il Servizio.',
    'terms.section3.title': '3. Descrizione del Servizio',
    'terms.section3.content1': 'Tradelia AI è una piattaforma SaaS che fornisce strumenti di analisi dati e reportistica attraverso metodologia accademica. Il Servizio include dashboard interattive e strumenti di visualizzazione.',
    'terms.section3.content2': '<strong>IMPORTANTE:</strong> Il Servizio fornisce strumenti di analisi e visualizzazione dati. Non costituisce consulenza finanziaria, investimento o raccomandazione di acquisto/vendita. I dati e le analisi sono forniti "così come sono" senza garanzie di accuratezza o completezza.',
    'terms.section4.title': '4. Abbonamenti e Pagamenti',
    'terms.section4.content1': 'L\'accesso al Servizio richiede un abbonamento a pagamento. I prezzi sono indicati nella pagina <a href="/pricing.html" style="color: var(--brand-600); text-decoration: underline;">Pricing</a> e possono essere modificati con preavviso di 30 giorni.',
    'terms.section4.content2': '<strong>Prova Gratuita:</strong> Offriamo un periodo di prova gratuita di 14 giorni. Durante questo periodo, hai accesso completo a tutte le funzionalità della dashboard senza alcun costo. Al termine dei 14 giorni, se non hai cancellato, l\'abbonamento si attiva automaticamente e verrà addebitato il prezzo mensile (€29/mese).',
    'terms.section4.content3': 'I pagamenti sono gestiti tramite Paddle. L\'abbonamento si rinnova automaticamente ogni mese fino a cancellazione. Puoi cancellare il tuo abbonamento in qualsiasi momento dalla dashboard, anche durante il periodo di prova gratuita, senza alcun costo.',
    'terms.section5.title': '5. Account e Sicurezza',
    'terms.section5.content': 'Sei responsabile di mantenere la riservatezza delle credenziali del tuo account. Notifica immediatamente eventuali accessi non autorizzati.',
    'terms.section6.title': '6. Limitazioni di Responsabilità',
    'terms.section6.content': 'Il Servizio è fornito "così come è" senza garanzie di alcun tipo. Tradelia AI non si assume responsabilità per:',
    ...
    'terms.section7.content': 'Tutti i contenuti del Servizio, inclusi ma non limitati a testi, grafici, loghi, icone, immagini e software, sono di proprietà di Tradelia AI o dei suoi fornitori di contenuti e sono protetti da leggi sul copyright e altre leggi sulla proprietà intellettuale.',
    'terms.section8.title': '8. Modifiche ai Termini',
    'terms.section8.content': 'Ci riserviamo il diritto di modificare questi Termini in qualsiasi momento. Le modifiche entreranno in vigore 30 giorni dopo la pubblicazione. L\'uso continuato del Servizio dopo le modifiche costituisce accettazione dei nuovi Termini.',
    'terms.section9.title': '9. Contatti',
    'terms.section9.content': 'Per domande su questi Termini, contattaci a: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    
    // Privacy
    'privacy.title': 'Privacy Policy',
    'privacy.lastUpdate': 'Ultimo aggiornamento:',
    'privacy.section1.title': '1. Introduzione',
    'privacy.section1.content': 'Tradelia AI ("noi", "nostro", "il Servizio") rispetta la tua privacy e si impegna a proteggere i tuoi dati personali. Questa Privacy Policy spiega come raccogliamo, utilizziamo e proteggiamo le tue informazioni quando utilizzi il nostro Servizio.',
    'privacy.section2.title': '2. Dati che Raccogliamo',
    'privacy.section2.content': 'Raccogliamo i seguenti tipi di dati:',
    'privacy.section2.item1': '<strong>Dati di account:</strong> Email, password (criptata), informazioni di abbonamento',
    'privacy.section2.item2': '<strong>Dati di utilizzo:</strong> Log di accesso, preferenze, interazioni con il Servizio',
    'privacy.section2.item3': '<strong>Dati tecnici:</strong> Indirizzo IP, tipo di browser, dispositivo',
    'privacy.section2.item4': '<strong>Dati di pagamento:</strong> Gestiti da Paddle (non conserviamo dati di carte di credito)',
    ...
    'privacy.section4.item2': '<strong>Supabase:</strong> Per autenticazione e database (hosting sicuro)',
    ...
    'privacy.section5.content': 'Implementiamo misure di sicurezza appropriate per proteggere i tuoi dati, inclusi:',
    ...
    'privacy.section6.content2': 'Per esercitare questi diritti, contattaci a: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    'privacy.section7.title': '7. Conservazione dei Dati',
    'privacy.section7.content': 'Conserviamo i tuoi dati personali solo per il tempo necessario a fornire il Servizio o come richiesto dalla legge. Quando cancelli il tuo account, eliminiamo i tuoi dati entro 30 giorni, salvo obblighi legali di conservazione.',
    'privacy.section8.title': '8. Cookie e Tecnologie Simili',
    'privacy.section8.content': 'Utilizziamo cookie e tecnologie simili per migliorare l\'esperienza utente, analizzare l\'utilizzo del Servizio e personalizzare i contenuti. Puoi gestire le preferenze dei cookie tramite le impostazioni del browser.',
    'privacy.section9.title': '9. Modifiche a questa Privacy Policy',
    'privacy.section9.content': 'Possiamo aggiornare questa Privacy Policy periodicamente. Ti notificheremo eventuali modifiche significative via email o tramite il Servizio.',
    'privacy.section10.title': '10. Contatti',
    'privacy.section10.content': 'Per domande su questa Privacy Policy, contattaci a: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    
    // Refund
    'refund.title': 'Politica di Rimborso',
    'refund.lastUpdate': 'Ultimo aggiornamento:',
    'refund.section1.title': '1. Prova Gratuita',
    'refund.section1.content1': 'Offriamo un <strong>periodo di prova gratuita di 14 giorni</strong> per tutti i nuovi abbonamenti. Durante questo periodo, hai accesso completo a tutte le funzionalità della dashboard senza alcun costo. Puoi cancellare in qualsiasi momento durante la prova gratuita senza addebiti.',
    'refund.section1.content2': 'Al termine dei 14 giorni, se non hai cancellato, l\'abbonamento si attiva automaticamente e verrà addebitato il prezzo mensile (€29/mese).',
    'refund.section2.title': '2. Periodo di Rimborso',
    'refund.section2.content': 'Se hai già pagato e non sei soddisfatto del Servizio, puoi richiedere un rimborso completo entro <strong>14 giorni dalla data del primo addebito</strong> (dopo il periodo di prova gratuita).',
    'refund.section3.title': '3. Come Richiedere un Rimborso',
    'refund.section3.content': 'Per richiedere un rimborso, contattaci a: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    ...
    'refund.section4.content1': 'Una volta ricevuta la richiesta, processeremo il rimborso entro <strong>5-7 giorni lavorativi</strong>. Il rimborso verrà accreditato sul metodo di pagamento originale utilizzato per l\'acquisto.',
    'refund.section4.content2': 'Dopo il rimborso, il tuo account verrà disattivato e perderai l\'accesso al Servizio.',
    'refund.section5.title': '5. Rimborsi Dopo il Periodo di Garanzia',
    'refund.section5.content': 'Dopo i 14 giorni, i rimborsi non sono garantiti. Tuttavia, valuteremo ogni richiesta caso per caso in circostanze eccezionali (es. problemi tecnici gravi non risolti).',
    'refund.section6.title': '6. Cancellazione dell\'Abbonamento',
    'refund.section6.content1': 'Puoi cancellare il tuo abbonamento in qualsiasi momento dalla dashboard, anche durante il periodo di prova gratuita. La cancellazione durante la prova gratuita non comporta alcun addebito.',
    'refund.section6.content2': 'Se cancelli dopo il periodo di prova, la cancellazione impedirà il rinnovo automatico, ma <strong>non</strong> comporta un rimborso per il periodo già pagato. Continuerai ad avere accesso al Servizio fino alla fine del periodo di abbonamento già pagato.',
    'refund.section7.title': '7. Contatti',
    'refund.section7.content': 'Per domande sulla politica di rimborso, contattaci a: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    ...
    'legal.mifid.risks.item1': 'I mercati finanziari comportano <strong>rischio di perdita, anche totale, del capitale</strong>.',
    'legal.mifid.risks.item2': 'Prodotti a leva/derivati (opzioni, futures, CFD) possono amplificare perdite oltre il capitale iniziale.',
    'legal.mifid.risks.item3': 'Rendimenti passati non sono indicativi di risultati futuri.',
    'legal.mifid.risks.item4': 'Le informazioni fornite non devono essere considerate come garanzie di rendimento.',
    'legal.mifid.data.title': 'Dati e fonti',
    'legal.mifid.data.item1': 'Dati e serie storiche possono essere soggetti a ritardi, revisioni o errori; i timestamp potrebbero non riflettere il "tempo reale".',
    'legal.mifid.data.item2': 'Le fonti includono provider ritenuti affidabili (Tier-1); non si garantisce esattezza/completezza assoluta.',
    'legal.mifid.data.item3': 'Le analisi AI sono generate automaticamente e possono contenere errori o imprecisioni.',
    'legal.mifid.independence.title': 'Conflitti e indipendenza',
    'legal.mifid.independence.item1': '<strong>Tradelia AI è indipendente</strong>: non esegue ordini, non gestisce capitali, non raccoglie depositi e non opera come intermediario finanziario.',
    'legal.mifid.independence.item2': 'Non sono note situazioni di conflitto d\'interesse rilevanti nella produzione del materiale.',
    'legal.mifid.independence.item3': 'Eventuali link a piattaforme o servizi esterni sono forniti a solo scopo informativo.',
    'legal.mifid.limitations.title': 'Limitazioni e responsabilità',
    'legal.mifid.limitations.item1': 'Le informazioni non sostituiscono il giudizio dell\'utente né la consulenza di un <strong>intermediario autorizzato</strong>.',
    'legal.mifid.limitations.item2': 'L\'utente è responsabile delle proprie decisioni di investimento.',
    'legal.mifid.limitations.item3': 'L\'uso del sito è vietato laddove non conforme alle leggi locali.',
    'legal.mifid.limitations.item4': 'Tradelia AI non si assume alcuna responsabilità per perdite derivanti dall\'uso delle informazioni fornite.',
    'legal.privacy.principles.title': 'Principi',
    'legal.privacy.principles.content': 'Adottiamo un\'impostazione "privacy-first": minimizzazione dei dati e assenza di tracciamento pubblicitario.',
    'legal.privacy.data.title': 'Dati trattati',
    'legal.privacy.data.item1': 'Nessuna raccolta di dati personali identificativi tramite questa pagina.',
    'legal.privacy.data.item2': 'Uso di <code>localStorage</code> per preferenze (tema) e consenso legale.',
    ...
    'legal.privacy.cookies.item1': 'Niente cookie di profilazione; eventuali analytics sono anonimizzati/aggregati.',
    ...
    'legal.privacy.rights.item1': 'Per informazioni o esercizio diritti privacy, scrivi a <a href="mailto:info@tradelia.org" class="mail-link">info@tradelia.org</a>.',
    'legal.privacy.rights.item2': 'Il titolare potrà aggiornare questa informativa: controlla periodicamente le revisioni.'
  },
  ...
  en: {
    ...
    'module.header.mifid.default': 'Output for educational/informational purposes (3–10 day horizon). Does not constitute advice or recommendation (MiFID II).',
    ...
    'pricing.faq.cancel.content': 'Yes, you can cancel your subscription at any time from the dashboard. You will continue to have access until the end of the period already paid.',
    'pricing.faq.trial.title': 'How does the free trial work?',
    'pricing.faq.trial.content': 'We offer a <strong>14-day free trial</strong> with no commitment. You can access all dashboard features without paying anything. At the end of 14 days, if you don\'t cancel, the subscription automatically activates at €29/month. You can cancel at any time during the free trial at no cost.',
    'pricing.faq.payment.title': 'How does payment work?',
    'pricing.faq.payment.content': 'Payments are securely processed through Paddle. The subscription automatically renews every month. You can change or cancel at any time.',
    
    // Terms
    'terms.title': 'Terms of Service',
    'terms.lastUpdate': 'Last updated:',
    'terms.section1.title': '1. Provider Identity',
    'terms.section1.content1': '<strong>Tradelia AI</strong> ("we", "our", "the Provider") is an independent project that provides financial analysis services through a SaaS platform.',
    'terms.section1.content2': '<strong>Provider Data:</strong><br>Trade name: Tradelia AI<br>Owner: Massimo Rodi<br>Email: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a><br>Website: <a href="https://tradelia.org" style="color: var(--brand-600); text-decoration: underline;">https://tradelia.org</a>',
    'terms.section2.title': '2. Acceptance of Terms',
    'terms.section2.content': 'By accessing and using Tradelia AI ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Service.',
    'terms.section3.title': '3. Service Description',
    'terms.section3.content1': 'Tradelia AI is a SaaS platform that provides data analysis tools and reporting through academic methodology. The Service includes interactive dashboards and visualization tools.',
    'terms.section3.content2': '<strong>IMPORTANT:</strong> The Service provides data analysis and visualization tools. It does not constitute financial advice, investment or purchase/sale recommendation. Data and analyses are provided "as is" without warranties of accuracy or completeness.',
    'terms.section4.title': '4. Subscriptions and Payments',
    'terms.section4.content1': 'Access to the Service requires a paid subscription. Prices are indicated on the <a href="/pricing.html" style="color: var(--brand-600); text-decoration: underline;">Pricing</a> page and may be changed with 30 days notice.',
    'terms.section4.content2': '<strong>Free Trial:</strong> We offer a 14-day free trial period. During this period, you have full access to all dashboard features at no cost. At the end of 14 days, if you have not cancelled, the subscription automatically activates and the monthly price (€29/month) will be charged.',
    'terms.section4.content3': 'Payments are processed through Paddle. The subscription automatically renews every month until cancellation. You can cancel your subscription at any time from the dashboard, including during the free trial period, at no cost.',
    'terms.section5.title': '5. Account and Security',
    'terms.section5.content': 'You are responsible for maintaining the confidentiality of your account credentials. Immediately notify us of any unauthorized access.',
    'terms.section6.title': '6. Liability Limitations',
    'terms.section6.content': 'The Service is provided "as is" without warranties of any kind. Tradelia AI assumes no responsibility for:',
    ...
    'terms.section7.content': 'All Service content, including but not limited to texts, graphics, logos, icons, images and software, is the property of Tradelia AI or its content providers and is protected by copyright laws and other intellectual property laws.',
    'terms.section8.title': '8. Changes to Terms',
    'terms.section8.content': 'We reserve the right to modify these Terms at any time. Changes will take effect 30 days after publication. Continued use of the Service after changes constitutes acceptance of the new Terms.',
    'terms.section9.title': '9. Contact',
    'terms.section9.content': 'For questions about these Terms, contact us at: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    
    // Privacy
    'privacy.title': 'Privacy Policy',
    'privacy.lastUpdate': 'Last updated:',
    'privacy.section1.title': '1. Introduction',
    'privacy.section1.content': 'Tradelia AI ("we", "our", "the Service") respects your privacy and is committed to protecting your personal data. This Privacy Policy explains how we collect, use and protect your information when you use our Service.',
    'privacy.section2.title': '2. Data We Collect',
    'privacy.section2.content': 'We collect the following types of data:',
    'privacy.section2.item1': '<strong>Account data:</strong> Email, password (encrypted), subscription information',
    'privacy.section2.item2': '<strong>Usage data:</strong> Access logs, preferences, Service interactions',
    'privacy.section2.item3': '<strong>Technical data:</strong> IP address, browser type, device',
    'privacy.section2.item4': '<strong>Payment data:</strong> Processed by Paddle (we do not store credit card data)',
    ...
    'privacy.section4.item2': '<strong>Supabase:</strong> For authentication and database (secure hosting)',
    ...
    'privacy.section5.content': 'We implement appropriate security measures to protect your data, including:',
    ...
    'privacy.section6.content2': 'To exercise these rights, contact us at: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    'privacy.section7.title': '7. Data Retention',
    'privacy.section7.content': 'We retain your personal data only for as long as necessary to provide the Service or as required by law. When you delete your account, we delete your data within 30 days, except for legal retention obligations.',
    'privacy.section8.title': '8. Cookies and Similar Technologies',
    'privacy.section8.content': 'We use cookies and similar technologies to improve user experience, analyze Service usage and customize content. You can manage cookie preferences through your browser settings.',
    'privacy.section9.title': '9. Changes to this Privacy Policy',
    'privacy.section9.content': 'We may update this Privacy Policy periodically. We will notify you of any significant changes via email or through the Service.',
    'privacy.section10.title': '10. Contact',
    'privacy.section10.content': 'For questions about this Privacy Policy, contact us at: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    
    // Refund
    'refund.title': 'Refund Policy',
    'refund.lastUpdate': 'Last updated:',
    'refund.section1.title': '1. Free Trial',
    'refund.section1.content1': 'We offer a <strong>14-day free trial period</strong> for all new subscriptions. During this period, you have full access to all dashboard features at no cost. You can cancel at any time during the free trial with no charges.',
    'refund.section1.content2': 'At the end of 14 days, if you have not cancelled, the subscription automatically activates and the monthly price (€29/month) will be charged.',
    'refund.section2.title': '2. Refund Period',
    'refund.section2.content': 'If you have already paid and are not satisfied with the Service, you can request a full refund within <strong>14 days of the first charge date</strong> (after the free trial period).',
    'refund.section3.title': '3. How to Request a Refund',
    'refund.section3.content': 'To request a refund, contact us at: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    ...
    'refund.section4.content1': 'Once we receive the request, we will process the refund within <strong>5-7 business days</strong>. The refund will be credited to the original payment method used for the purchase.',
    'refund.section4.content2': 'After the refund, your account will be deactivated and you will lose access to the Service.',
    'refund.section5.title': '5. Refunds After Guarantee Period',
    'refund.section5.content': 'After 14 days, refunds are not guaranteed. However, we will evaluate each request on a case-by-case basis in exceptional circumstances (e.g. serious unresolved technical issues).',
    'refund.section6.title': '6. Subscription Cancellation',
    'refund.section6.content1': 'You can cancel your subscription at any time from the dashboard, including during the free trial period. Cancellation during the free trial does not result in any charges.',
    'refund.section6.content2': 'If you cancel after the trial period, cancellation will prevent automatic renewal, but does <strong>not</strong> result in a refund for the period already paid. You will continue to have access to the Service until the end of the subscription period already paid.',
    'refund.section7.title': '7. Contact',
    'refund.section7.content': 'For questions about the refund policy, contact us at: <a href="mailto:info@tradelia.org" style="color: var(--brand-600); text-decoration: underline;">info@tradelia.org</a>',
    ...
    'legal.overlay.continue': 'By continuing you declare that you have read and understood the information.',
    'legal.mifid.purpose.title': 'Purpose of the material',
    'legal.mifid.purpose.content': 'This website and all its content (analyses, AI modules, reports, articles, glossary) are for <strong>informational and educational purposes only</strong>. They do not constitute investment advice, personalized recommendation, public savings solicitation or investment research under <strong>MiFID II / ESMA</strong> regulations.',
    'legal.mifid.educational.title': 'Educational nature',
    'legal.mifid.educational.content': 'Tradelia AI is a platform for <strong>academic financial education</strong>. All content, including proprietary AI modules, market analyses, reports and educational tools, are designed exclusively for educational and research purposes. No adequacy/appropriateness verification, risk profile or user financial objectives are performed.',
    'legal.mifid.risks.title': 'Risks',
    'legal.mifid.risks.item1': 'Financial markets involve <strong>risk of loss, including total loss of capital</strong>.',
    'legal.mifid.risks.item2': 'Leveraged/derivative products (options, futures, CFDs) can amplify losses beyond initial capital.',
    'legal.mifid.risks.item3': 'Past returns are not indicative of future results.',
    'legal.mifid.risks.item4': 'The information provided should not be considered as guarantees of returns.',
    'legal.mifid.data.title': 'Data and sources',
    'legal.mifid.data.item1': 'Data and historical series may be subject to delays, revisions or errors; timestamps may not reflect "real time".',
    'legal.mifid.data.item2': 'Sources include providers considered reliable (Tier-1); absolute accuracy/completeness is not guaranteed.',
    'legal.mifid.data.item3': 'AI analyses are automatically generated and may contain errors or inaccuracies.',
    'legal.mifid.independence.title': 'Conflicts and independence',
    'legal.mifid.independence.item1': '<strong>Tradelia AI is independent</strong>: it does not execute orders, manage capital, collect deposits or operate as a financial intermediary.',
    'legal.mifid.independence.item2': 'No known relevant conflict of interest situations in material production.',
    'legal.mifid.independence.item3': 'Any links to external platforms or services are provided for informational purposes only.',
    'legal.mifid.limitations.title': 'Limitations and liability',
    'legal.mifid.limitations.item1': 'Information does not replace user judgment nor the advice of an <strong>authorized intermediary</strong>.',
    'legal.mifid.limitations.item2': 'The user is responsible for their own investment decisions.',
    'legal.mifid.limitations.item3': 'Use of the site is prohibited where not compliant with local laws.',
    'legal.mifid.limitations.item4': 'Tradelia AI assumes no responsibility for losses resulting from use of the information provided.',
    'legal.privacy.principles.title': 'Principles',
    'legal.privacy.principles.content': 'We adopt a "privacy-first" approach: data minimization and no advertising tracking.',
    ...
    'legal.privacy.data.item2': 'Use of <code>localStorage</code> for preferences (theme) and legal consent.',
    ...
    'legal.privacy.rights.item1': 'For information or to exercise privacy rights, write to <a href="mailto:info@tradelia.org" class="mail-link">info@tradelia.org</a>.',
    'legal.privacy.rights.item2': 'The data controller may update this information: check revisions periodically.'
  }
};
