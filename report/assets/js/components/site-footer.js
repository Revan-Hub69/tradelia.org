        ...
        <div class="ftr-col">
          <div class="ftr-head">
            <a href="/index.html" class="ftr-logo-link" aria-label="Tradelia AI - Homepage">
              <img src="/logos/tradelia-logo.svg?v=4" alt="Tradelia AI" class="ftr-logo" width="240" height="60" style="display: block; height: 44px; width: auto; max-width: 260px; object-fit: contain;" />
            </a>
