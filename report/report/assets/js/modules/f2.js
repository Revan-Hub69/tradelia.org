...
function buildF2SectionsPublic(d){
  ...
  const sintesiHTML = `
    <section class="tl-panel-section" data-f2-section="sintesi" style="background:transparent;border:0;border-radius:0;box-shadow:none;padding:0;">
      <header class="tl-panel-section-title"><div class="tl-panel-section-title-text">Conclusione · Framework Accademico AI, Tradelia Swing Master 5.0 (educational)</div></header>
      ${points}
