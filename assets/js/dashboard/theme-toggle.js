...
function setupToggleButton() {
  // Cerca sia #theme-toggle che #btn-theme-toggle (banner)
  const toggleBtn =
    document.getElementById("theme-toggle") || document.getElementById("btn-theme-toggle");
  if (!toggleBtn) {
    return;
  }
...
function updateToggleIcon(theme) {
  // Cerca tutti i toggle (sia #theme-toggle che #btn-theme-toggle)
  const toggleBtns = [
  ...
  toggleBtns.forEach((toggleBtn) => {
    ...
    if (theme === "dark") {
      ...
      toggleBtn.setAttribute("title", "Passa a tema chiaro");
    } else {
      ...
      toggleBtn.setAttribute("title", "Passa a tema scuro");
    }
  });
}

// Export per uso globale
window.updateThemeToggleIcon = updateToggleIcon;
