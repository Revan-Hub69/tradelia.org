...
const FRAMEWORK_DOCS = {
  ...
  mtb: {
    ...
    description:
      "Framework per analisi macroeconomica e contesto tattico multi-fattore con integrazione sentiment.",
    docs: [
  ...
  pac: {
    ...
    description:
      "Protocollo specializzato per monitoraggio e analisi del mercato delle criptovalute.",
    docs: [
