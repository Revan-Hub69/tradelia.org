...
export const F1B_EXPLANATIONS = {
  ...
  'StrategyMode_macro': {
    ...
    fonte: 'Carhart, M.M. (1997). On Persistence in Mutual Fund Performance. Journal of Finance, 52(1), 57-82.',
    esempio: 'Se VIX < 20, RegimeScore +0.5, Breadth 0.75, settori growth leader → StrategyMode = Momentum'
  },
  ...
  'RegimeScore': {
    ...
    fonte: 'Adrian, T., Crump, R.K., & Moench, E. (2013). Pricing the Term Structure with Linear Regressions. Journal of Financial Economics, 110(1), 110-138.',
  ...
  'VolRegime': {
    ...
    fonte: 'Whaley, R.E. (2009). Understanding VIX. Journal of Portfolio Management, 35(3), 98-105.',
  ...
  'Breadth_1M': {
    ...
    fonte: 'Breadth indicators sono standard in technical analysis. Vedi: Zweig, M.E. (1970). A New Look at the Market.',
  ...
  'RiskTilt_1M': {
    ...
    fonte: 'Sector rotation è un indicatore di sentiment. Vedi: Fama, E.F., & French, K.R. (1992). The Cross-Section of Expected Stock Returns.',
  ...
  'SmallCapPressure_1W': {
    ...
    fonte: 'Size effect è documentato in letteratura. Vedi: Banz, R.W. (1981). The Relationship Between Return and Market Value of Common Stocks.',
  ...
  'LeadersMultiTF': {
    ...
    fonte: 'Sector leadership è un indicatore di trend sostenuto. Vedi: Sector rotation analysis in technical analysis.',
    esempio: 'Technology, Communication Services, Consumer Discretionary con performance positive su tutti i timeframe → LeadersMultiTF'
  },
  ...
  'StressMicroCap': {
    ...
    fonte: 'Micro cap sono più sensibili a condizioni di funding. Vedi: Research su small cap liquidity risk.',
  ...
  'FinvizQuery': {
    ...
    fonte: 'Filter generation basata su regime analysis. Vedi: Dynamic screening in quantitative trading.',
    esempio: 'Query: "sector:(Technology OR CommunicationServices) AND marketcap:Large AND performance:MonthUp AND RSI(14)<70"'
  },
  ...
  'CreditRiskBlock': {
    ...
    fonte: 'Credit spreads sono indicatori di stress finanziario. Vedi: Gilchrist, S., & Zakrajšek, E. (2012). Credit Spreads and Business Cycle Fluctuations.',
  ...
  'FX_Regime': {
    ...
    fonte: 'Dollar strength impatta asset globali. Vedi: Dornbusch, R. (1976). Expectations and Exchange Rate Dynamics.',
  ...
  'LiquidityRegimeScore': {
    ...
    fonte: 'Liquidity conditions impattano mercati. Vedi: Brunnermeier, M.K. (2009). Deciphering the Liquidity and Credit Crunch.',
    esempio: 'VIX basso, credito disteso, curva steepening → LiquidityRegimeScore positivo (liquidità buona)'
  },
  ...
  'RiskWindow': {
    ...
    fonte: 'Risk window analysis è parte del risk management. Vedi: Risk management frameworks in portfolio management.',
