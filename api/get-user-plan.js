...
async function handleRequest(req, res) {
  ...
  if (!activePlan) {
    // BEST PRACTICE: Utente autenticato ma senza piano attivo = guest
    // Non esiste "authenticated" come piano, solo guest/pro/desk
    return sendJSON(res, 200, {
      ok: true,
      plan: {
        type: "guest", // Utente autenticato ma senza piano attivo = guest
        status: "active",
        startedAt: null,
        expiresAt: null,
        xoloPaymentStatus: null,
