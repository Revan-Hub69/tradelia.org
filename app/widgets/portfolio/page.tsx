    ...
    <div className="min-h-screen bg-bg-base p-4 flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-text-primary mb-2">
          {t('widgets.portfolio.title') || 'Portfolio Widget'}
        </h1>
        <p className="text-text-secondary mb-6">
          {t('widgets.portfolio.comingSoon') || 'Questo widget sarà disponibile a breve. Stiamo lavorando all\'integrazione delle API necessarie.'}
        </p>
