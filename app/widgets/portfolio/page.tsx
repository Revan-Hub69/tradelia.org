  ...
  return (
    <div className="min-h-screen bg-bg-base p-4 flex items-center justify-center">
      <div className="w-full max-w-2xl">
        <FeatureComingSoon
          featureName={locale === 'it' ? 'Portfolio Widget' : 'Portfolio Widget'}
          description={locale === 'it' 
            ? 'Gestisci il tuo portafoglio con aggiornamenti real-time'
            : 'Manage your portfolio with real-time updates'}
          reason={locale === 'it'
