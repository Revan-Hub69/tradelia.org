          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-text-secondary leading-relaxed max-w-2xl font-light">
                Explore complete training paths, browse verifiable public reports, 
                access documented AI frameworks and manage your analysis requests. 
                Everything free, open and compliant with academic standards.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
              <div className="rounded-2xl border border-border-subtle/60 bg-bg-surface/60 backdrop-blur-sm p-5">
                ...
                <dd className="text-text-primary text-base font-medium leading-relaxed">
                  Every framework is documented with methodological notes and public datasets
                </dd>
              </div>
              ...
              <div className="rounded-2xl border border-border-subtle/60 bg-bg-surface/60 backdrop-blur-sm p-5">
                ...
                <dd className="text-text-primary text-base font-medium leading-relaxed">
                  Training paths and reports always free, optional pro services
                </dd>
              </div>
            </div>
