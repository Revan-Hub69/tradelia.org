...
export async function GET(request: NextRequest) {
  try {
    ...
    const leverageMetrics = {
      ...
      recommendedLeverage: futuresData.liquidationRisk === 'very-high' ? 5 : 
                           futuresData.liquidationRisk === 'high' ? 10 : 20,
    };
    ...
    const fundingRateImpact = {
      ...
      interpretation: futuresData.fundingRate > 0.1 ? 'very-bullish' :
                     futuresData.fundingRate > 0.05 ? 'bullish' :
                     futuresData.fundingRate > -0.05 ? 'neutral' :
                     futuresData.fundingRate > -0.1 ? 'bearish' : 'very-bearish',
    };
