...
export async function GET(request: Request) {
  try {
    ...
    // Calculate trend from historical data (would need to fetch historical sentiment)
    // For now, use current sentiment as baseline
    const trend = {
      score7d: sentiment, // Would calculate from 7-day average
      score30d: sentiment, // Would calculate from 30-day average
