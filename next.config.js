        ...
        headers: [
          ...
          // Content Security Policy - Enhanced Security
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://*.supabase.in wss://*.supabase.co https://api.binance.com https://fapi.binance.com https://api.coingecko.com https://api.whale-alert.io https://api.finnhub.io https://api.alphavantage.co https://api.tradingeconomics.com https://api.santiment.net https://api.reddit.com https://api.github.com https://api.groq.com https://api.openai.com https://api.fred.stlouisfed.org https://api.cboe.com https://newsapi.org https://api.glassnode.com",
