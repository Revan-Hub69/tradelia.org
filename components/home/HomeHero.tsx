    ...
    <section className={styles.heroSection}>
      <div className={styles.heroContainer}>
        <div className={styles.heroBadge}>
          ...
          <span>Formazione Finanziaria Accademica</span>
        </div>
        <h1 className={styles.heroTitle}>
          La piattaforma di <span className={styles.heroTitleHighlight}>formazione finanziaria</span> più avanzata al mondo
        </h1>
        <p className={styles.heroDescription}>
          Framework AI proprietari verificabili, metodologie documentate e percorsi formativi completi.
          <br />
          <strong>Gratuito, accessibile, conforme agli standard accademici internazionali.</strong>
        </p>
