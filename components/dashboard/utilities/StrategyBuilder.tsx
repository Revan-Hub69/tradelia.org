...
import type { OptimizationResult, WalkForwardWindow } from './strategy-builder/types';
import { StrategyBuilderHeader } from './strategy-builder/StrategyBuilderHeader';
import { StrategyBuilderDisclaimers } from './strategy-builder/StrategyBuilderDisclaimers';
...
export function StrategyBuilder() {
  ...
  return (
    ...
    >
      ...
      <StrategyBuilderHeader locale={locale} />
      <StrategyBuilderDisclaimers locale={locale} />
