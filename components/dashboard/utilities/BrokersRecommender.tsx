...
// Lista broker disponibili (recuperata da vecchie versioni)
const availableBrokers: Broker[] = [
  {
    id: 'etoro',
    name: 'eToro',
    logo: '/logos/etoro.svg',
    description: 'Piattaforma social trading leader con copy trading e community attiva',
    regulatory: ['CySEC', 'FCA', 'ASIC'],
    platforms: ['Web', 'Mobile', 'Desktop'],
    instruments: ['Forex', 'Azioni', 'Crypto', 'ETF', 'Commodities'],
    minDeposit: 50,
    leverage: 'Fino a 30:1',
    spread: 'Variabile',
    commission: '0% su azioni, spread su forex',
    taxRegime: 'dichiarativo',
    educationLevel: 'beginner',
    pros: ['Copy trading', 'Commissioni zero su azioni', 'Regolamentato', 'Community attiva'],
    cons: ['Spread più alti', 'Leverage limitato'],
    rating: 4.5,
  },
  {
    id: 'plus500',
    ...
    description: 'Broker CFD con piattaforma intuitiva e spread competitivi',
    regulatory: ['FCA', 'CySEC', 'ASIC'],
    platforms: ['Web', 'Mobile'],
    instruments: ['CFD', 'Forex', 'Crypto', 'Indici', 'Commodities'],
    minDeposit: 100,
    leverage: 'Fino a 30:1',
    spread: 'Competitivi',
    commission: '0% (solo spread)',
    taxRegime: 'dichiarativo',
    educationLevel: 'beginner',
    pros: ['Piattaforma semplice', 'Spread competitivi', 'Nessuna commissione'],
    cons: ['Limitato a CFD', 'Supporto clienti base'],
    rating: 4.2,
  },
  {
    id: 'fxpro',
    ...
    description: 'Broker professionale con piattaforme avanzate e condizioni competitive',
    regulatory: ['FCA', 'CySEC', 'FSCA'],
    platforms: ['MT4', 'MT5', 'cTrader', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Azioni', 'Crypto'],
    minDeposit: 100,
    ...
    pros: ['Piattaforme professionali', 'Spread competitivi', 'Regolamentato'],
    cons: ['Più complesso per principianti'],
    rating: 4.6,
  },
  {
    id: 'pepperstone',
    ...
    description: 'Broker ECN con spread ultra-competitivi e esecuzione veloce',
    regulatory: ['FCA', 'ASIC', 'DFSA'],
    platforms: ['MT4', 'MT5', 'cTrader', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Crypto'],
    minDeposit: 200,
    leverage: 'Fino a 500:1',
    spread: 'Da 0.0 pips',
    commission: 'Da $3.50 per lotto',
    taxRegime: 'dichiarativo',
    educationLevel: 'advanced',
    pros: ['Spread ultra-competitivi', 'Esecuzione veloce', 'ECN puro'],
    cons: ['Commissioni su alcuni account', 'Minimo deposito più alto'],
    rating: 4.7,
  },
  {
    id: 'xm',
    name: 'XM',
    logo: '/logos/xm.svg',
    description: 'Broker globale con bonus e condizioni favorevoli per tutti i livelli',
    regulatory: ['CySEC', 'FCA', 'ASIC'],
    platforms: ['MT4', 'MT5', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Azioni', 'Crypto'],
    minDeposit: 5,
    leverage: 'Fino a 888:1',
    spread: 'Da 0.6 pips',
    commission: '0%',
    taxRegime: 'dichiarativo',
    educationLevel: 'all',
    pros: ['Minimo deposito basso', 'Bonus disponibili', 'Supporto multilingue'],
    cons: ['Spread più alti su alcuni strumenti'],
    rating: 4.4,
  },
  {
    id: 'avatrade',
    ...
    description: 'Broker regolamentato con protezione saldo negativo e formazione',
    regulatory: ['Central Bank of Ireland', 'ASIC', 'FSCA'],
    platforms: ['AvaTradeGO', 'MT4', 'MT5', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Azioni', 'ETF', 'Crypto'],
    minDeposit: 100,
    leverage: 'Fino a 400:1',
    spread: 'Da 0.9 pips',
    commission: '0%',
    taxRegime: 'dichiarativo',
    educationLevel: 'beginner',
    pros: ['Protezione saldo negativo', 'Formazione inclusa', 'Regolamentato'],
    cons: ['Spread più alti'],
    rating: 4.3,
  },
  {
    id: 'fpmarkets',
    ...
    description: 'Broker australiano con spread competitivi e piattaforme professionali',
    regulatory: ['ASIC', 'CySEC'],
    platforms: ['MT4', 'MT5', 'IRESS', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Azioni', 'Crypto'],
    minDeposit: 100,
    leverage: 'Fino a 500:1',
    spread: 'Da 0.0 pips',
    commission: 'Da $3 per lotto',
    taxRegime: 'dichiarativo',
    educationLevel: 'intermediate',
    pros: ['Spread competitivi', 'Piattaforme professionali', 'Regolamentato'],
    cons: ['Commissioni su account ECN'],
    rating: 4.5,
  },
  {
    id: 'exante',
    ...
    description: 'Broker multi-asset con accesso a mercati globali e strumenti avanzati',
    regulatory: ['MFSA', 'CySEC', 'FCA'],
    platforms: ['Exante Terminal', 'Web', 'Mobile'],
    instruments: ['Azioni', 'ETF', 'Bond', 'Derivati', 'Crypto'],
    minDeposit: 10000,
    leverage: 'Variabile',
    spread: 'Variabile',
    commission: 'Da €0.02 per azione',
    taxRegime: 'both',
    educationLevel: 'advanced',
    pros: ['Accesso globale', 'Strumenti avanzati', 'Regime amministrato disponibile'],
    cons: ['Minimo deposito alto', 'Più complesso'],
    rating: 4.6,
  },
  {
    id: 'blackbull',
    ...
    description: 'Broker ECN con spread competitivi e esecuzione veloce',
    regulatory: ['FMA', 'FSA'],
    platforms: ['MT4', 'MT5', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Crypto'],
    minDeposit: 200,
    ...
    taxRegime: 'dichiarativo',
    educationLevel: 'intermediate',
    pros: ['Spread competitivi', 'Esecuzione veloce', 'ECN'],
    cons: ['Commissioni su account ECN'],
    rating: 4.5,
  },
  {
    ...
    description: 'Broker CFD con condizioni competitive e piattaforme professionali',
    regulatory: ['ASIC', 'FCA'],
    platforms: ['MT4', 'MT5', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Crypto'],
    minDeposit: 100,
  ...
  },
  {
    ...
    name: 'NAGA',
    logo: '/logos/naga.svg',
    description: 'Piattaforma social trading con copy trading e community',
    regulatory: ['CySEC', 'FCA'],
    platforms: ['NAGA Trader', 'Web', 'Mobile'],
    instruments: ['Forex', 'Azioni', 'Crypto', 'ETF', 'Indici'],
    minDeposit: 250,
    leverage: 'Fino a 30:1',
    spread: 'Variabile',
    commission: '0% su azioni',
    taxRegime: 'dichiarativo',
    educationLevel: 'beginner',
    pros: ['Copy trading', 'Commissioni zero su azioni', 'Community attiva'],
    cons: ['Leverage limitato'],
    rating: 4.3,
  },
  {
    id: 'skilling',
    ...
    description: 'Broker moderno con piattaforma intuitiva e spread competitivi',
    regulatory: ['CySEC', 'FSA'],
    platforms: ['Skilling Trader', 'Web', 'Mobile'],
    instruments: ['Forex', 'Indici', 'Commodities', 'Crypto'],
    minDeposit: 100,
    leverage: 'Fino a 500:1',
    spread: 'Da 0.1 pips',
    ...
    taxRegime: 'dichiarativo',
    educationLevel: 'beginner',
    pros: ['Piattaforma moderna', 'Spread competitivi', 'Nessuna commissione'],
    cons: ['Limitato a CFD'],
    rating: 4.4,
  },
  {
    ...
    description: 'Broker per trading azioni con accesso a mercati globali',
    regulatory: ['CySEC'],
    platforms: ['Freedom24', 'Web', 'Mobile'],
    instruments: ['Azioni', 'ETF', 'Bond'],
    minDeposit: 0,
    leverage: 'N/A',
    spread: 'N/A',
    ...
    taxRegime: 'both',
    educationLevel: 'all',
    pros: ['Commissioni basse', 'Accesso globale', 'Regime amministrato disponibile'],
    cons: ['Solo azioni/ETF', 'Nessun leverage'],
    rating: 4.3,
  },
];
