...
export function NewsFeed() {
  ...
  const getImpactColor = (score: number) => {
    ...
    return 'text-text-secondary bg-background-secondary/50';
  };
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-4">
        ...
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-bg-base border border-border-subtle rounded-lg text-text-primary placeholder-text-tertiary focus:outline-none focus:ring-2 focus:ring-blue-500/25"
          />
        </div>
      </div>
        ...
        {loading ? (
          ...
          translatedNews.map((item, index) => (
              <a
                ...
                className={cn(
                  'block bg-bg-base border border-border-subtle rounded-lg p-4 transition-all hover:border-blue-500/25 hover:shadow-md group',
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {item.credibilityScore && (
                        <span className="text-xs px-2 py-0.5 rounded bg-background-secondary/50 text-text-secondary flex items-center gap-1">
                    ...
                    <h3 className="text-sm font-semibold text-white mb-1 line-clamp-2 group-hover:underline group-hover:underline-offset-2 group-hover:decoration-blue-500/25 transition-all">
                  ...
                  <div className="flex items-center gap-2 text-xs text-text-tertiary">
                    ...
                    <ExternalLink className="w-3 h-3 text-text-secondary group-hover:text-white transition-colors" />
                  </div>
                </div>
              </div>
            </a>
